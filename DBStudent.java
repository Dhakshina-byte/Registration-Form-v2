...
public class DBStudent {
    public static Connection connect() {
        ...
        try {
            ...
            sDB.execute(
                   "Create Table if not exists Student_details(StudentID int primary key auto_increment, Student_Name varchar(300),Student_Address varchar(300),Student_City varchar(300),Student_mail varchar(300),Student_ContactNumber int
            sDB.execute(
